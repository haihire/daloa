...
('낙원 스킬트리', 'https://sites.google.com/view/achi-loa/%EB%82%99%EC%9B%90/%EB%82%99%EC%9B%90-%EC%8B%9C%EC%A6%8C2', '스킬트리', '각 직업별 낙원 시즌2 스킬트리 모음.', 'https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=https://lostark.game.onstove.com&size=32'),
('낙원 장비',    'https://codepen.io/ialgqfxp-the-animator/pen/NPrQxOx',                                             '장비',     '각 직업별 낙원 장비 모음.', 'https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=https://lostark.game.onstove.com&size=32');
