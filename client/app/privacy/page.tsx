...
export default function PrivacyPage() {
  return (
    <PageShell title="개인정보처리방침" updatedAt={POLICY_UPDATED_AT}>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>쿠팡 주식회사</td>
              <td>
                광고 게재. 쿠키를 통해 이용자의 쿠팡 이용 이력을 바탕으로 상품
                광고가 노출됩니다.
              </td>
            </tr>
            <tr>
      ...
      <h3>광고 쿠키</h3>
      <p>
        사이트는 <strong>쿠팡 파트너스</strong>를 통해 상품 광고를 게재합니다.
        광고 영역은 쿠팡이 제공하는 별도 프레임으로 표시되며, 해당 영역의 데이터
        처리는 쿠팡 주식회사의 개인정보처리방침을 따릅니다.
      </p>
      <ul>
        <li>
          광고는 <strong>고객 관심 기반 추천</strong> 방식입니다. 이용자가
          쿠팡에서 조회하거나 구매한 이력을 바탕으로 상품이 노출될 수 있습니다.
        </li>
        <li>
          로모아는 이 과정에서 이용자의 쇼핑 이력이나 식별 정보를 전달받지
          않으며, 어떤 정보도 저장하지 않습니다.
        </li>
        <li>
          맞춤형 광고를 원하지 않으시면 브라우저의 쿠키 차단 기능을 사용하거나,
          쿠팡 계정의 광고 설정에서 개인 맞춤 광고를 해제할 수 있습니다.
        </li>
        <li>
          이용자가 광고를 클릭해 상품을 구매하면 로모아가 쿠팡으로부터 일정액의
          수수료를 받습니다. 이 사실은 사이트 하단에 상시 고지하고 있습니다.
        </li>
      </ul>
